...
(function() {
  (function() {
    var BITS, BUF, CONST, NUM32, NUM64, REG, exports, finalize, finishInPlace, hashArrayBuffer, hashDate, hashFloat32, hashFloat64, hashInPlace, hashInt32, hashInt64, hashNumber, hashString, hashTypedArray, imul, mix, root;
    ...
    mix = function(hash, data) {
      REG[0] = data | 0;
      REG[1] = hash | 0;
      hashInPlace();
      return REG[1];
    };
    finalize = function(hash) {
      REG[1] = hash | 0;
      finishInPlace();
      return REG[1];
    };
